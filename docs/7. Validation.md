...
| eq_field       | Equal| field, required |
| equal          | Value must be equal | value, required |
| gt_field       | Greater Than | field, required |
| gte_field      | Greater Than or Equal | field, required |
...
| lt_field       | Less Than | field, required |
| lte_field      | Less Than or Equal| field, required |
...
| neq_field      | Not Equal| field, required |
